...
if ( CLIENT ) then
	SWEP.PrintName			= "Purple Scissor Blade"	--Name of the SWEP
	...
	killicon.AddFont("weapon_scissorblade_purple", "CSKillIcons", SWEP.IconLetter, Color( 255, 80, 0, 255 ))	--Sexy KillIcon. Too bad I don't know how to make a custom one work.
...
SWEP.WElements = {
	["scissor"] = {
		type = "Model", model = "models/anfrien/kill_la_kill/scissor_blade/purple_scissor_blade.mdl", bone = "ValveBiped.Bip01_R_Hand",
...
SWEP.VElements = {
	["scissor"] = {
		type = "Model", model = "models/anfrien/kill_la_kill/scissor_blade/purple_scissor_blade.mdl", bone = "v_weapon.Knife_Handle",
		rel = "", pos = Vector(-0.151, -1, -1), angle = Angle(-30, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255),
		surpresslightning = false, material = "", skin = 0, bodygroup = {}
	}
}
